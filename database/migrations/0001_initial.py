# Generated by Django 2.2.12 on 2020-05-05 20:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_nauczyciela', models.ForeignKey(blank=True, db_column='ID_nauczyciela', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='database.Nauczyciel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_klasy', models.ForeignKey(db_column='ID_klasy', on_delete=django.db.models.deletion.DO_NOTHING, to='database.Klasa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adres', models.CharField(max_length=30)),
                ('email', models.CharField(max_length=40)),
                ('klasa', models.CharField(blank=True, max_length=10, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='klasa',
            name='id_wychowawcy',
            field=models.ForeignKey(blank=True, db_column='ID_wychowawcy', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='database.Nauczyciel'),
        ),
    ]
